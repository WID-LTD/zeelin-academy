                ...
                <div key={card.title}
                  ...
                  <div className="space-y-2 lg:space-y-3 mb-6 flex-grow">
                    {card.features.map((f) => {
                      const FIcon = f.icon
                      return (
                        <div key={f.text} className="flex items-center gap-2 lg:gap-3">
                          <FIcon className="w-5 h-5 lg:w-6 lg:h-6" style={{ color: 'var(--brand-gold)' }} />
                          <span className="text-sm md:text-base lg:text-lg" style={{ color: 'rgba(255,255,255,0.9)' }}>{f.text}</span>
                        </div>
                      )
                    })}
                  </div>
                  ...
                  <div className="space-y-2 lg:space-y-3 mb-6 flex-grow">
                    {card.features.map((f) => {
                      ...
                      return (
                        <div key={f.text} className="flex items-center gap-2 lg:gap-3">
                          <FIcon className="w-5 h-5 lg:w-6 lg:h-6" style={{ color: 'var(--brand-gold)' }} />
                          <span className="text-sm md:text-base lg:text-lg" style={{ color: 'var(--text-core)' }}>{f.text}</span>
                        </div>
                      )
                    })}
                  </div>
