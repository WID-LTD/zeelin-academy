...
import { ChevronRight, ClipboardList, Lightbulb, Zap, Star, Calendar, Clock, ShieldCheck, Users, CheckCircle, Award, BookOpen, MessageCircle, BarChart3, User } from 'lucide-react'
...
export default function OralExaminationPage() {
  return (
    <div className="min-h-screen">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {[
              ...
              <AnimatedSection key={i} delay={i * 100}>
                <div className="flex items-start gap-5 lg:gap-6 p-5 lg:p-6 rounded-2xl border" style={{ backgroundColor: 'rgba(255,255,255,0.6)', backdropFilter: 'blur(8px)', borderColor: 'var(--border)' }}>
                  <div className="w-12 h-12 lg:w-14 lg:h-14 rounded-xl flex items-center justify-center flex-shrink-0 font-black text-base lg:text-lg" style={{ backgroundColor: 'rgba(212,175,55,0.1)', color: 'var(--brand-gold)' }}>
                    {step.step}
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            {[
              ...
              <AnimatedSection key={i} delay={i * 80}>
                <div className="p-5 lg:p-6 rounded-2xl border h-full text-center" style={{ backgroundColor: 'rgba(255,255,255,0.6)', backdropFilter: 'blur(8px)', borderColor: 'var(--border)' }}>
                  <tip.icon className="w-9 h-9 lg:w-10 lg:h-10 mx-auto mb-4" style={{ color: 'var(--brand-gold)' }} />
        ...
        <div className="max-w-[1200px] xl:max-w-[1400px] 2xl:max-w-[1600px] 3xl:max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto">
            {[
              ...
              <AnimatedSection key={i} delay={i * 100}>
                <div className={`p-6 lg:p-8 rounded-2xl border flex flex-col h-full ${pkg.highlight ? 'relative' : ''}`} style={{
                  backgroundColor: pkg.highlight ? 'rgba(255,255,255,0.8)' : 'rgba(255,255,255,0.6)',
      ...
      {/* Booking CTA */}
      <section className="py-16 md:py-20 lg:py-24 course-section-divider">
        <div className="max-w-[1200px] xl:max-w-[1400px] 2xl:max-w-[1600px] 3xl:max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            <Calendar className="w-14 h-14 lg:w-16 lg:h-16 mx-auto mb-6" style={{ color: 'var(--brand-gold)' }} />
            <h2 className="font-display text-3xl sm:text-4xl lg:text-5xl font-black mb-4" style={{ color: 'var(--text-core)' }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/enroll" className="btn-gold px-8 lg:px-10 py-3 lg:py-4 text-lg font-bold inline-flex items-center gap-3">
                <Calendar className="w-5 h-5" />
                Book Your Exam
              </Link>
              <Link href="/contact" className="btn-outline-gold px-8 lg:px-10 py-3 lg:py-4 text-lg font-bold inline-flex items-center gap-3">
