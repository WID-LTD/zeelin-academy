  ...
  return (
    <div className="min-h-screen py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          {weeks.map((week) => (
            <div key={week.num} className="relative pl-12 pb-12 last:pb-0">
              <div className="absolute left-[23px] top-0 bottom-0 w-px last:hidden bg-[color:var(--border)]" />
              <div className="absolute left-0 top-0 w-[46px] h-[46px] rounded-full gold-bg flex items-center justify-center font-bold text-[color:var(--text-core)]">
                {week.num}
              </div>
              <div className="ml-4 p-6 rounded-xl border bg-[color:var(--bg-card)] border-[color:var(--border)]">
        ...
        <div className="text-center mt-16 p-12 rounded-2xl border bg-[color:var(--bg-secondary)] border-[color:var(--border)]">
