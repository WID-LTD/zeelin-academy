...
export default function OfferSection() {
  return (
    <section className="relative overflow-hidden pb-16 md:pb-28 pt-0" style={{ backgroundColor: 'transparent' }}>
      {/* Decorative glow */}
        ...
        <AnimatedSection delay={100}>
          <div className="text-center max-w-4xl mx-auto mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl font-semibold mb-6" style={{ color: 'var(--text-secondary)' }}>
              Prepare for the Professional Qualification in Business Analysis with structured teaching, guided study, mock quizzes, visual summaries, and exam-readiness support.
            </p>
          ...
          {routes.map((route, idx) => {
            ...
            return (
              <AnimatedSection key={route.title} delay={100 + idx * 120} duration={600}>
                <div
                  className="p-8 rounded-2xl border transition-all duration-300 shadow-sm hover:shadow-xl h-full flex flex-col hover:border-[rgba(212,160,42,0.3)] group"
                ...
                >
                  <div className="flex items-center gap-4 mb-5">
                    ...
                    <h3 className="font-display text-xl font-black leading-snug" style={{ color: 'var(--text-core)' }}>
                      {route.title}
                    </h3>
                  </div>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <span className="text-sm font-bold px-3 py-1 rounded-full border"
                      style={{ color: 'var(--brand-gold)', borderColor: 'rgba(212,160,42,0.3)', backgroundColor: 'rgba(212,160,42,0.08)' }}>
                      {route.duration}
                    </span>
                  ...
                  <p className="text-base font-semibold leading-relaxed flex-1 mb-6" style={{ color: 'var(--text-secondary)' }}>
                    {route.description}
                  </p>

                  <Link
                    href={route.href}
                    className="btn-gold px-6 py-3 text-base font-bold text-center inline-block hover:scale-105 transition-transform"
                  >
                    {route.btnLabel}
                  </Link>
                </div>
        ...
        <AnimatedSection delay={400}>
          <div className="relative mt-16 rounded-2xl overflow-hidden text-center p-6 sm:p-10 md:p-14 border"
            ...
            <div className="relative">
              ...
              <h3 className="font-display text-3xl md:text-4xl font-bold mb-2" style={{ color: 'var(--text-core)' }}>
                Not sure which route is right for you?
              </h3>

              <p className="text-lg md:text-xl font-semibold max-w-2xl mx-auto mb-8 leading-relaxed"
                style={{ color: 'var(--text-secondary)' }}>
                Use our Diploma Pathway Finder to choose with clarity.
              </p>

              <Link href="/pathway-finder" className="btn-gold px-8 sm:px-12 py-4 text-lg font-bold inline-block hover:scale-105 transition-transform">
