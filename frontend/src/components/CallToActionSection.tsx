...
export default function CallToActionSection() {
  return (
    <section style={{ backgroundColor: 'var(--navy-dark)', color: 'var(--white)', textAlign: 'center', padding: '3.75rem 1.25rem' }}>
      <div className="max-w-[1280px] 3xl:max-w-[2240px] mx-auto">
        ...
        <div style={{ display: 'flex', gap: '1.125rem', justifyContent: 'center', flexWrap: 'wrap' }}>
