      ...
      <div className="max-w-[2560px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-2xl overflow-hidden">
          ...
          <div className="relative p-6 sm:p-12 md:p-16 text-center" style={{ backgroundColor: 'rgba(223,186,107,0.05)' }}>
            <h2 className="font-display text-3xl md:text-4xl 3xl:text-5xl font-bold mb-4" style={{ color: 'var(--text-core)' }}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 mb-6">
              <span className="text-2xl sm:text-3xl 3xl:text-4xl font-bold text-gray-400 line-through">£499</span>
              <div className="px-3 py-1 rounded-lg text-xs sm:text-sm 3xl:text-base font-bold animate-pulse-gold whitespace-nowrap" style={{ background: 'linear-gradient(135deg, #dc2626, #b91c1c)', color: 'white' }}>
                Save 40%
              </div>
              <span className="text-3xl sm:text-4xl 3xl:text-5xl font-bold" style={{ color: 'var(--brand-gold)' }}>£299</span>
            </div>
            ...
            <div className="flex items-center justify-center gap-2 sm:gap-4 mb-8">
              {[
                ...
                <div key={unit.label} className="text-center">
                  <div className="w-12 sm:w-14 h-12 sm:h-14 3xl:w-16 3xl:h-16 rounded-xl flex items-center justify-center text-base sm:text-xl 3xl:text-2xl font-bold shadow-lg" style={{ backgroundColor: 'var(--bg-card)', color: 'var(--brand-gold)', border: '1px solid var(--border)' }}>
